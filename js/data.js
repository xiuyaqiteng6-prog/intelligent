...
// クールダウン中に撫でた時の反応
export const PAT_COOLDOWN_LINES = [
  '照れくさいから、少し時間をおいてね。',
  'まださっきの余韻が残ってるよ。',
  'ふふ、そんなに急かさなくても大丈夫。',
];

// 内省中、新しい繋がりが生まれた時にランダムで添えるひとこと
export const REFLECT_INSIGHT_LINES = [
  'が、頭の中でふと繋がった。',
  'の間に、思いがけない共通点を見つけた。',
  'が呼応するのを感じた。',
  'を辿ると、もう一方にたどり着いた。',
...
// 知識クイズの正解・不正解リアクション
export const QUIZ_RIGHT_LINES = [
  '正解。よくわかったね。',
  'その通り。嬉しいな、わかってもらえて。',
  'うん、合ってる。絆が深まった気がする。',
];
export const QUIZ_WRONG_LINES = [
  '惜しい、違ったみたい。でも考えてくれて嬉しい。',
  'ううん、違うよ。でも大丈夫、また今度。',
  '不正解……だけど、一緒に考える時間は好きだよ。',
];
